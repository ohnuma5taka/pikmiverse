...
import chappyImg from "@/assets/images/chappy.png";
import gameMainBgImg from "@/assets/images/game_main_bg.png";
...
import clearGif from "@/assets/images/tutorial_2.png";
import leafIcon from "@/assets/icons/leaf-2-line.svg";
...
const ASSETS = {
  bg: gameMainBgImg,
  pikmin: pikminWalkGif,
  enemy: chappyImg,
  ghost: pikminGhostImg,
  spawnButton: spawnButtonImg,
  tutorial1: tutorial1Img,
  tutorial2: tutorial2Img,
  flower: flowerImg,
  clear: clearGif,
  leaf: leafIcon,
  time: timeIcon,
    ...
    >
      ...
      {(gameState === "tutorial-1" || gameState === "tutorial-2") && (
        ...
        >
          ...
          >
            ...
            <img
              src={
                gameState === "tutorial-1" ? ASSETS.tutorial1 : ASSETS.tutorial2
              }
      ...
      {(gameState === "playing" || gameState === "clear") && (
        <>
          ...
          <div className="absolute top-0 left-0 w-full flex justify-between items-start z-30 pointer-events-none">
            {/* Top Center Card */}
            <div className="absolute left-1/2 -translate-x-1/2 -translate-y-1/5">
              <img src={ASSETS.flower} alt="Flower" />
            </div>
            <div className="absolute top-4 left-1/2 -translate-x-1/2 pointer-events-auto">
              <div className="flex flex-col items-center bg-white/60 backdrop-blur-md border border-white px-4 py-2 rounded-2xl shadow-lg">
                <span className="text-[#00823C] tracking-widest font-semibold">
                  {team?.name ?? "Loading..."}
                </span>
                <div className="flex items-center gap-2">
                  <span className="text-[#00823C] font-bold text-xl font-sans tracking-wider">
                    {team?.score ?? 0}/{TARGET_SCORE}
                  </span>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <div className="w-full aspect-square rounded-full overflow-hidden border-2 border-white/10 shadow-lg bg-black/20 backdrop-blur-sm">
                  <img
                    src={ASSETS.enemy}
          ...
          >
            ...
            {rank ? (
              <div className="w-full flex flex-col gap-2 font-bold">
                ...
                <div className="w-full flex justify-between">
                  <span className="text-xl">あなたが送ったパワー</span>
                  <span className="text-xl text-[#00823C]">
                    <img
                      src={ASSETS.leaf}
                      alt="Leaf"
